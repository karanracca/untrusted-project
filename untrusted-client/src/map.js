...
export default function Map(rotDisplay, __game) {
    /* private variables */
    ...
    this._properties = {};
    this._display = rotDisplay.__getDisplay;
    ...
    this._reset = function () {
        ...
        __objectDefinitions = util.getListOfObjects(__game);
    ...
    this.placePlayer = wrapExposedMethod(function (x, y) {
        ...
        __player = new Player(x, y, this, __game);
        rotDisplay.drawAll(this);
    }, this);
